...
public class TestGestionDePersonalEscenario2 { //Escenario con lista vacia, para conocer los numeros de casos verificar la documentacion de testing
	private Local local;
	...
	public void testBajaOperarioCaso2() {
		Operario operario= new Operario(5,"NahuelNievas", "13/10/1996","Nahuel", "contrasenia");
		try{
	...
	public void testBajaOperarioCaso3() {
		try{
			GestionDePersonal.getInstance().bajaOperario(null);
			Assert.fail("No deberia seguir con la ejecucion");
		}
		catch(Exception e) {
	...
	public void testAltaMozoCaso1() {
		...
		assertEquals("El id no se genera correctamente", mozo.getId(), 20000);
