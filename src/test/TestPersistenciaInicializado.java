...
public class TestPersistenciaInicializado {
	private Local local;
	...
	@Test
    public void testLocalVacioArchivo()
    {
        try
        {
            ...
            Assert.assertEquals("Los diccionarios deberían ser vacíos", local1,Local.getInstance()); 
        }
        catch (Exception e)
        {
            Assert.fail("No debería lanzar excepcion: " + e.getMessage());
