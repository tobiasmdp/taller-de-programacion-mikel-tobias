...
public class ControladorMozoMesa implements ActionListener,Observer {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(comando.equals("CREAR")) {
			Local.getInstance().getAsignacionDiaria().add(new AsignacionDiaria(this.vista.getListaMozoSeleccionada(),this.vista.getListaMesaSeleccionada()));
			this.vista.removeMozo(this.vista.getListaMozoSeleccionada());
