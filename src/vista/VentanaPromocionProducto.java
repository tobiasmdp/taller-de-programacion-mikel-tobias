...
public class VentanaPromocionProducto extends JFrame implements IVista{
	...
	public VentanaPromocionProducto() {
		...
		btnNuevaMesa = new JButton("Nueva Promocion Producto");
		...
		btnModificaMesa = new JButton("Modificar Promocion Producto");
		...
		btnEliminarMesa = new JButton("Eliminar Promocion Producto");
