...
public class VentanaPromocionTemporal extends JFrame implements IVista{
	...
	public VentanaPromocionTemporal() {
		...
		btnNuevaMesa = new JButton("Nueva Promocion Temporal");
		...
		btnModificaMesa = new JButton("Modificar Promocion Temporal");
		...
		btnEliminarMesa = new JButton("Eliminar Promocion Temporal");
