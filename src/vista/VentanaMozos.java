...
public class VentanaMozos extends JFrame implements IVista{
	...
	public VentanaMozos() {
		...
		btnNuevaMesa = new JButton("Nuevo Mozo");
		...
		btnModificaMesa = new JButton("Modificar Mozo");
		...
		btnEliminarMesa = new JButton("Eliminar Mozo");
