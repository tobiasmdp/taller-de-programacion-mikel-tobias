...
public class VentanaProducto extends JFrame implements IVista{
	...
	public VentanaProducto() {
		...
		btnNuevaMesa = new JButton("Nueva Producto");
		...
		btnModificaMesa = new JButton("Modificar Producto");
		...
		btnEliminarMesa = new JButton("Eliminar Producto");
